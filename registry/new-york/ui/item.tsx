...
function Item({
  ...
  return (
    <div
      data-slot="item"
      className={cn(
        "flex items-start gap-[var(--ds-internal-gap)] rounded-[var(--ds-element-radius)] p-[var(--ds-internal-gap)] transition-colors hover:bg-accent hover:text-accent-foreground data-[selected=true]:bg-[color:var(--selected)] data-[selected=true]:text-[color:var(--selected-foreground)]",
        className
      )}
      {...props}
    >
