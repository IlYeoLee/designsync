    ...
    <TabsVariantContext.Provider value={variant}>
      <TabsPrimitive.List
        ...
        className={cn(
          ...
          variant === "underline" &&
            "relative w-full border-b border-[color:var(--divider)] gap-0 bg-transparent p-0 rounded-none h-auto justify-start",
          className
        )}
        {...props}
      />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        variant === "pill" &&
          "rounded-[var(--ds-element-radius)] px-2 py-1 text-muted-foreground data-[state=active]:bg-[color:var(--selected)] data-[state=active]:text-[color:var(--selected-foreground)] data-[state=active]:shadow-xs focus-visible:border-ring focus-visible:outline-ring focus-visible:outline-1",
        variant === "underline" &&
