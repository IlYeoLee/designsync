...
export async function POST(req: NextRequest) {
  try {
    ...
    // CLAUDE.md — AI coding rules generated from rules.ts
    const claudeMd = [
      `# DesignSync — AI Coding Rules`,
      `# Auto-generated by DesignSync. Re-run save to update.`,
      ``,
      generateRules({
        fontFamily: ds.tokens?.primitives?.fontFamily || "",
        fontFamilyKo: ds.tokens?.primitives?.fontFamilyKo || "",
        fontSansValue,
        iconLibrary: ds.icon_library || "lucide",
