...
// ── Generate DesignSync ESLint config snippet ───────────────────────
function generateEslintConfig(): string {
  return `// eslint.config.designsync.mjs — DesignSync enforcement rules
// Add to your eslint.config.mjs: ...designsyncRules
// Auto-generated by DesignSync. Do not edit manually.

const RAW_HTML_NO_DS = [
  { el: "button",   ds: "<Button>" },
  { el: "select",   ds: "<NativeSelect> or <Select>" },
  { el: "textarea", ds: "<Textarea>" },
  { el: "h1", ds: "<TypographyH1>" }, { el: "h2", ds: "<TypographyH2>" },
  { el: "h3", ds: "<TypographyH3>" }, { el: "h4", ds: "<TypographyH4>" },
  { el: "aside", ds: "<Sidebar>" },
  { el: "table", ds: "<Table> or <DataTable>" },
  { el: "thead", ds: "<TableHeader>" }, { el: "tbody", ds: "<TableBody>" },
  { el: "tr", ds: "<TableRow>" }, { el: "th", ds: "<TableHead>" }, { el: "td", ds: "<TableCell>" },
];
...
const BANNED_COLORS = [
  ...
  { pat: "bg-rose-", fix: "bg-destructive/10" },
...
export const designsyncRules = [
  {
    files: ["src/**/*.tsx", "app/**/*.tsx", "components/**/*.tsx"],
    rules: {
      "no-restricted-syntax": ["error",
        ...RAW_HTML_NO_DS.map(({ el, ds }) => ({
          selector: \`JSXOpeningElement[name.name="\${el}"]\`,
          message: \`\u274c DS: use \${ds} instead of raw <\${el}>\`,
        })),
        ...BANNED_COLORS.map(({ pat, fix }) => ({
        ...
        })),
        {
          ...
          message: "\u274c DS: rounded-xl/2xl \u2192 rounded-[var(--ds-card-radius)]",
        },
      ],
    },
  },
